export const drills = [
  ...
  },
  {
    ...
    subject: 'Points',
    difficulty: 'Beginner',
    scoreKey: 'dexterity_point_drill_large'
  },
  {
    name: 'Medium Points',
    url: 'dexterity_point_drill.html',
    description: 'Improve pointer accuracy with rapid taps.',
    category: 'Dexterity',
    subject: 'Points',
    difficulty: 'Adept',
    scoreKey: 'dexterity_point_drill'
  },
  {
    name: 'Small Points',
    url: 'dexterity_point_drill_small.html',
    description: 'Point drill with smaller targets for higher precision.',
    category: 'Dexterity',
    subject: 'Points',
    difficulty: 'Expert',
